# ✨ 小米平板 Hyper OS 系统功能增强附加模块

自动构建适用于 **小米平板 Hyper OS 系统功能增强的 Magisk 模块**，提取 ROM 自动生成模块文件。

当前支持 **Android 14 和 Android 15** 的Hyper OS For Pad。

---

## 📚 文档目录

- [✨ 小米平板 Hyper OS 系统功能增强附加模块](#-小米平板 Hyper OS 系统功能增强附加模块)
  - [📚 文档目录](#-文档目录)
  - [💡 模块功能说明](#-模块功能说明)
